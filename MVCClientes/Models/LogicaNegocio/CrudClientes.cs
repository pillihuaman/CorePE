...
namespace ProjectClienteWallet.Models.LogicaNegocio
{
    public class CrudClientes
    {
        ...
        public static String DeleteClientes(int Idcliente)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = SqlDbAdapter.GetConexion())
                {
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        cmd.Connection = con;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.CommandText = "ZUSP_DELETECLIENTE";
                        ...
                        using (SqlDataReader re = cmd.ExecuteReader())
                        {
                            while (re.Read())
                            {
                                RESPUESTA = "Se proceso correctamente;";
            ...
            catch (Exception ex)
            {
                ...
                RESPUESTA = ex.ToString() + "Se Presento inconvenientes  :";
